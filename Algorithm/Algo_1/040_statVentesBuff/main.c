/* ========================================================================== */
/* Statistique des ventes - Version bufferisee                                */
/* ========================================================================== */
...
#include "C:\C\utilitaires\entetes\fichierBuff.h"
...
/* -------------------------------------------------------------------------- */
   char  cr_nosect[3];  /* Numero de secteur sur lequel on travaille          */
   char  cr_norep[4];   /* Numero de representant sur lequel on travaille     */
   char  cr_nocli[5];   /* Numero de client sur lequel on travaille           */
...
/* -------------------------------------------------------------------------- */
   ...
   fichierVersements = fbopen(nomfich, "rb", sizeof(VERSEMENT), 4);
...
/* -------------------------------------------------------------------------- */
   strcpy(nomfich, "C:\\C\\fichiers\\statVentesBuff.txt");
...
/* Debut du programme                                                         */
/* -------------------------------------------------------------------------- */
   getDateSysteme8(chaineDate);

   fbread(&versement, fichierVersements);
   if (fbeof(fichierVersements))
      chaineMax(versement.nosect, sizeof(versement.nosect));
...
/* -------------------------------------------------------------------------- */
            ...
            while ((strcmp(cr_nosect, versement.nosect) == 0) &&
